...
//
#define TFT_SCK 14  // SCLK can also use pin 14 if you tell the driver to use software mode (see lib examples)
#define TFT_MOSI 7  // MOSI can also use pin 7 if you tell the driver to use software mode (see lib examples)
#define TFT_CS   20  // CS & DC can use pins 2, 6, 9, 10, 15, 20, 21, 22, 23
#define TFT_DC   21   //  but certain pairs must NOT be used: 2+10, 6+9, 20+23, 21+22
