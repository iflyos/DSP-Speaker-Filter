 ...
 *  
 *  Jan. 16 2022, modified by AG4RZ to include a "divide by 4" to allow for finer control of the filter settings
 *  I also slightly modified the code for the libraries I have on my machine, primarily for the TFT display
 */
...
bool rotaryChangedState() {
  ...
  rotaryNewPosition = (knob.read()/4); //Divide by 4 to increment one at a time
